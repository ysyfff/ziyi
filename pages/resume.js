      ...
      <div className="info ml5">
        ...
        <ul>
          <li>
            <div className="flex-between">
              <span>本人简历网页版</span>
              <a href="https://ziyi.vercel.app/resume" target="_blank">
                ziyi.vercel.app/resume
              </a>
              <span>React+next</span>
            </div>
          </li>
          ...
          <li>
            <div className="flex-between">
              <span>家庭视频合集</span>
              <a href="http://tsnow.top:60/video" target="_blank">
                tsnow.top:60/video
              </a>
              <span>React+next+mongodb</span>
            </div>
          </li>
        </ul>
